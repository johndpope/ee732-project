...
% 'save'
% 0 --> saves only the INTERposterior matrix
% 1 --> saves also MCMC trace plots (default)
%
% OUTPUT
...
% DBmcmc_Application('data',dataIN,'save',0)
%     Saves only the INTERposterior matrix, but not 
